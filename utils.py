...
def fit_result(x, y, estimator, random_seeds_start = 2, random_seeds_stop = 42, random_seeds_step = 2, testsize = 0.2):
...
def plot_multi_learning_curves(x, y, estimator1, random_seed = 42, testsize = 0.2, mode = 'r2', autosave = 'n', interval = 1, path = None):
    ...
    if mode == 'rmse':
        ...
        plt.xticks(size = 22)
        plt.yticks(size = 22)
        plt.title("RF performance with increasing number of training examples", fontsize=24)
